...
class myDemo(ShowBase):
    ...
    def loadModels(self):
        ...
        self.piece4.reparentTo(render)
        self.piece4.setPos(-1.63,7,4.3)
        self.piece4.setHpr(51,0,0)
    ...
    def rotatePiece(self):
        ...
        piece4interval2=self.piece4.posInterval(2, Point3(-0.46,7.95,5))
        piece4Movement=Parallel(piece4interval1, piece4interval2)
        piece4Movement.start()
        if self.rotation[2]%4==1:
            self.success=True
        self.success=False
