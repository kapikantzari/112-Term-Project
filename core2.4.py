...
def placeExtraTri(triEnds):
	...
	if distance(fx,fy,fz,x1,y1,z1)<distance(fx,fy,fz,x2,y2,z2) and (dx,dy,dz)==(0,7,0):
		...
		z=fz-dz
	if i==0:
		triEnds.insert(0,(x+endy,y+endx,z+endz))
	else: triEnds.append((x+endy,y+endx,z+endz))
	h=90
	p,r=0,0
